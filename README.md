...
Если в анкете нет пройденных тем или предложений там будет или пустой массив, или null. 
...
Кроме того, если хоть один лишний знак будет в ответе (знак препинания или буква другого регистра) - то в базе он не найдется (вернется ошибка - ответ не найден, смю ниже).
