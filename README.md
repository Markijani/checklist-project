...
В application.properties указан адрес локального компьютера - для тестирования необходим ввод имени пользователи и пароля, заданных на используемом компьютере. 
